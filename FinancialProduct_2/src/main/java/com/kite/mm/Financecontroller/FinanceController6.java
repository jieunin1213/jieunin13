package com.kite.mm.Financecontroller;
...
@Controller
public class FinanceController6 {


	
	@CrossOrigin
	@RequestMapping("/function/finance6")
	public String getInfo(Model model) throws UnsupportedEncodingException {
		...
		String url = "http://finlife.fss.or.kr/finlifeapi/creditLoanProductsSearch.xml"
				+ "?auth="+ dcodeKey
				+ "&topFinGrpNo=050000"
				+ "&pageNo=1";
		...
		model.addAttribute("result6", result);

		return "function/finance6";		
	}
