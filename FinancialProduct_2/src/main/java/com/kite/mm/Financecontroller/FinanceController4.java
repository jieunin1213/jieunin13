...
@Controller
public class FinanceController4 {


	
	@CrossOrigin
	@RequestMapping("/function/finance4")
	public String getInfo(Model model) throws UnsupportedEncodingException {
		...
		String url = "http://finlife.fss.or.kr/finlifeapi/mortgageLoanProductsSearch.xml"
				+ "?auth="+ dcodeKey
				+ "&topFinGrpNo=050000"
				+ "&pageNo=1";
